 ...
 * limitations under the Laicense.
 */

import React from 'react';
import PropTypes from 'prop-types';

class ProcessSelectionModal extends React.Component {
  render() {
      ...
      <div style={backdropStyle}>
        <div className="bx--modal-container" style={modalStyle}>
          <div className="bx--modal-header">
            <p className="bx--modal-header__heading bx--type-beta" id="process-selection-modal-heading">Select Process</p>
...
ProcessSelectionModal.propTypes = {
